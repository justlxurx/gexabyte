...
const SEOkeywords = ["tech culture", "blockchain", "etc"];
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="We create complex products using artificial intelligence, cloud solutions, blockchain and computer vision"
        />
