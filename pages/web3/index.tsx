    ...
    <GlobalLayout>
      <Wrapper>
        <Head>
          ...
          <meta
            name="description"
            content="Development of blockchain products for your ideas"
          />
        </Head>
        <FirstBlock>
          <Web3LeftSide>
            <Web3Title className={i18n.language === "en" ? "" : "geometria"}>
              {t("web3.title")}    
            </Web3Title>
            ...
            <StyledContainedButton
              className={i18n.language === "en" ? "" : "nunito"}
        ...
        <SecondBlock className={i18n.language === "en" ? "" : "geometria"}>
          <SecondBlockTitle>
            {t("web3.stats.title.0")}
            <br />
            <OrangeText>{t("web3.stats.title.1")}</OrangeText>
            <br />
            {t("web3.stats.title.2")}&nbsp;
            <OrangeText>{t("web3.stats.title.3")}</OrangeText>
          </SecondBlockTitle>
